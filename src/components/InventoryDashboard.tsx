                ...
                <div className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <div className="text-right ml-4">
                      <div className={`text-3xl font-bold ${hasLowStock ? 'text-red-600' : 'text-green-600'}`}>
                        {totalStock}
                      </div>
                                ...
                                {batch.warehouse_location && (
                                  <div className="flex items-start gap-2">
                                    ...
                                    <div>
                                      ...
                                      <div className="text-sm text-gray-900">{batch.warehouse_location}</div>
                                    </div>
                                  </div>
                                )}
                                {batch.cold_storage && (
                                  <div className="flex items-start gap-2">
                                    ...
                                    <div>
                                      ...
                                      <div className="text-sm text-blue-600">Cold Storage</div>
                                    </div>
                                  </div>
                                )}
                                {batch.supplier_name && (
                                  <div>
                                    ...
                                    <div className="text-sm text-gray-900">{batch.supplier_name}</div>
                                  </div>
                                )}
                              </div>
                            </div>
